...
class PaginationLibAjax{
	...
	var $next_link			= '<i class="fa fa-angle-right" aria-hidden="true"></i>';
	var $prev_link			= '<i class="fa fa-angle-left" aria-hidden="true"></i>';  
   ...
   var $show_count      = true;
	...
	function getAJAXlink( $count, $text) {   
		...
		return "<a class='ajax_send' value='$count'  href=\"javascript:void(0);\"" . $this->anchor_class . ">". $text .'</a>';
	}  
}
