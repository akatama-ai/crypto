...
<html>
	<head>
		...
		<title><?php echo  "Forgot Password - ".$settings['title']; ?></title>
	...
	<body class="hold-transition login-page">
		<div class="login-box">
			...
			<div class="login-box-body">
				<p class="login-box-msg">Enter Username or Email below to reset your password</p>
				<?php
				...
				<form role="form" method="post" action="<?php echo base_url(AUTH_CONTROLLER."/forgot-password"); ?>">
					...
					<div class="row">
						<div class="col-xs-4">
							<button type="submit" name="submit" class="btn btn-success btn-block btn-flat"><i class="fa fa-sign-in"></i> Reset</button>
						</div>
					</div>
				</form>
